...
public abstract class CallerConfiguration {
    ...
    /* The int value that indicate that access is fully denied/allowed or controlled for this IP */
     ...
     */
    protected CallerConfiguration(long unitTime, int maximumRequest, long prohibitTimePeriod,
                                  String ID) {
        this();
