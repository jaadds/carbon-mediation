...
package org.wso2.carbon.mediation.throttle.module.handler;
...
import org.wso2.carbon.mediation.throttle.core.AccessInformation;
import org.wso2.carbon.mediation.throttle.core.AccessRateController;
import org.wso2.carbon.mediation.throttle.core.ConcurrentAccessController;
import org.wso2.carbon.mediation.throttle.core.RoleBasedAccessRateController;
import org.wso2.carbon.mediation.throttle.core.Throttle;
import org.wso2.carbon.mediation.throttle.core.ThrottleConfiguration;
import org.wso2.carbon.mediation.throttle.core.ThrottleConstants;
import org.wso2.carbon.mediation.throttle.core.ThrottleContext;
import org.wso2.carbon.mediation.throttle.core.ThrottleException;
import org.wso2.carbon.mediation.throttle.module.utils.StatCollector;
import org.wso2.carbon.mediation.throttle.module.utils.impl.DummyAuthenticator;
import org.wso2.carbon.mediation.throttle.module.utils.impl.DummyHandler;
...
public abstract class ThrottleHandler extends AbstractHandler {
     ...
     * @throws org.wso2.carbon.mediation.throttle.core.ThrottleException Throws if the throttle type is unsupported
     */
     ...
     * @throws org.apache.axis2.AxisFault         Throws when access must deny for caller
     * @throws org.wso2.carbon.mediation.throttle.core.ThrottleException    ThrottleException
     */
