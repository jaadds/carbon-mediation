...
*  under the License.
*/
package org.wso2.carbon.mediation.throttle.core;
...
public class ThrottleFactoryTest extends TestCase {
    ...
    private String modulePolicy = "<wsp:Policy xmlns:wsp=\"http://schemas.xmlsoap.org/ws/2004/09/" +
            "policy\"\n" +
            ...
            "    </wsp:Policy>\n" +
            "    <wsp:Policy>\n" +
            "        <throttle:ID throttle:type=\"IP\">10.100.1.160 - 10.100.1.165 " +
            "</throttle:ID>\n" +
            "        <wsp:Policy>\n" +
            "            <throttle:Control>\n" +
            "                <wsp:Policy>\n" +
    ...
    private String oldPolicy = "<wsp:Policy xmlns:wsp=\"http://schemas.xmlsoap.org/ws/2004/09/" +
            "policy\"\n" +
            "            xmlns:throttle=\"http://www.wso2.org/products/wso2commons/throttle\">\n" +
    ...
    private String servicePolicy = "<wsp:Policy xmlns:wsp=\"http://schemas.xmlsoap.org/ws/" +
            "2004/09/policy\"\n" +
            "                xmlns:throttle=\"http://www.wso2.org/products/wso2commons/" +
            "throttle\">\n" +
    ...
    private String opPolicy = "<wsp:Policy xmlns:wsp=\"http://schemas.xmlsoap.org/ws/" +
            "2004/09/policy\"\n" +
            "                xmlns:throttle=\"http://www.wso2.org/products/wso2commons/" +
            "throttle\">\n" +
            "        <throttle:OperationThrottleAssertion>\n" +
            "            <throttle:MaximumConcurrentAccess> 5" +
    ...
    private String testXMl = "<wsp:Policy xmlns:wsp=\"http://schemas.xmlsoap.org/ws/" +
            "2004/09/policy\"\n" +
            "            xmlns:throttle=\"http://www.wso2.org/products/wso2commons/throttle\">\n" +
            "    <wsp:Policy>\n" +
            "        <wsp:ExactlyOne>\n" +
    ...
    public void testModuleThrottleAssertBuilder() throws Exception {
        ...
        org.apache.synapse.commons.throttle.core.Throttle throttle = ThrottleFactory.createModuleThrottle(policy);
        ...
        org.apache.synapse.commons.throttle.core.Throttle oldThrottle = ThrottleFactory.createModuleThrottle(oldPolicy);
        ...
        org.apache.synapse.commons.throttle.core.Throttle allThrottle = ThrottleFactory.createServiceThrottle(allPolicy);
        ...
        org.apache.synapse.commons.throttle.core.Throttle opThrottle = ThrottleFactory.createOperationThrottle(opPolicy);
        ...
        org.apache.synapse.commons.throttle.core.Throttle defaultThrottle = ThrottleFactory.createModuleThrottle(
